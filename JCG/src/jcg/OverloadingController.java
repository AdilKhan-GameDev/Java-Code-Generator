 ...
 * @author HVARZM
 */
public class OverloadingController implements Initializable {
    
    @FXML private TextField aclass_name;
    @FXML private TextField method_access;
