...
public class InterfaceController implements Initializable {
    ...
    @FXML private TextField interface_name;
    @FXML private TextField interface_access;
    @FXML private Button generate;
    
    public void GenerateButtonPushed(ActionEvent event)throws IOException{
        FileHandling fh = new FileHandling();
        
        fh.setInterfaceName(this.interface_name.getText());
        fh.setInterfaceAccess(this.interface_access.getText());
