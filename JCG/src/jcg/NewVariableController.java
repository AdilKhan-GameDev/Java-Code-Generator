...
public class NewVariableController implements Initializable {
    ...
    @FXML private TextField var_type;
    @FXML private TextField var_access;
    @FXML private TextField var_scope;
    @FXML private TextField var_name;
    ...
    public void GenerateButtonPushed(ActionEvent event)throws IOException{
        ...
        fh.setVar_Access(this.var_access.getText());
        fh.setVar_Name(this.var_name.getText());
        fh.setVar_Scope(this.var_scope.getText());
        fh.setVar_Type(this.var_type.getText());
