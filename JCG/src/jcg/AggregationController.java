...
public class AggregationController implements Initializable {
    ...
    public void GenerateButtonPushed(ActionEvent event)throws IOException{
        ...
        fh.setBCAccess(this.bclass_access.getText());
        
        fh.createAggregation();
    }
