 ...
 * @author HVARZM
 */
public class OverridingController implements Initializable {
    
    
    @FXML private TextField aclass_name;
    @FXML private TextField bclass_name;
    @FXML private TextField cclass_name;
    @FXML private TextField method_name;
    @FXML private TextField method_type;
    ...
    public void GenerateButtonPushed(ActionEvent event)throws IOException{
        ...
        fh.setBCName(this.bclass_name.getText());
        fh.setCCName(this.cclass_name.getText());
        fh.setAMType(this.method_type.getText());
